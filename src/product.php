...
<div class = "jumbotron">
    <p class = "lead">Select from the dropdown menu to get info related to each product!</p>
    <hr class = "my-4">
    <form method="GET" action="product.php">
        <select name="Name" onchange='this.form.submit()'>
            <option selected style="color: black;">Select a name</option>
            <?php
